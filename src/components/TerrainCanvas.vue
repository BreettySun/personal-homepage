...
watch(
	...
	([w, s, i]) => sceneApi?.setWeather(w, s, i),
);
watch(theme, () =>
	requestAnimationFrame(() => sceneApi?.setColors(readColors())),
);
watch(
	() => props.hovered,
	(h) => sceneApi?.setHovered(h),
);
watch(
	() => props.opacity,
	(o) => sceneApi?.setOpacity(o),
);
